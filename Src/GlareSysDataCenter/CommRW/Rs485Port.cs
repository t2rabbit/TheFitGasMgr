...
namespace GlareSysDataCenter.CommRW
{
 	class Rs485Port : IPort
 	{
        ...
        public void SetDBDev(MemCfgInfo.MemCardWithCommDev commDev)
 		{
 			_commDev = commDev;
 		}
 		...
 		public bool  Open()
 		{
            ...
            catch (System.Exception ex)
            {
 			...
 			m_serialPort.PortName = _commDev.cardInfo.CommSerialPort;
 			m_serialPort.BaudRate = (int)_commDev.cardInfo.CommSerialBaud;
            ...
            m_serialPort.StopBits = StopBits.One;
 			...
 			{
                LogMgr.WriteInfoDefSys("comm open ex:" + ex.Message);
 				bOpen = false;
 			}
 		...
 		public byte[] Read()
 		{
            try
            {
                ...
                while (true)
                {
                    ...
                    iRtyMS += 50;
                    if (iRtyMS > _commDev.cardInfo.CommTimeoutMs)
                    {
                        break;
                    }
                    Thread.Sleep(50);
                ...
                if (pRecBuf[iBytesToRead - 1] != GlareLedSysDefPub.GasCardDef.BT_CmdEnd)
                {
                    Thread.Sleep(100);
                    ...
                    if (iAppend > 0)
                    {
                        ...
                        LogMgr.WriteInfoDefSys("-- append -- len ");
                    }
                ...
                if (pRecBuf != null)
                {
                    ...
                    LogMgr.WriteInfoDefSys("rec:" + strRec);
                }
 ...
 /*
        ...
        {
            //IList<GlareLedSysDefPub.GasCardDef.CardOilValEachNumAByte> lstOilVals = GLLedProtocol.MakeOilValBytesByString(lstStrings);
        ...
        /// <returns></returns>
        public bool GetCfg(int iAddr, ref GlareLedSysDefPub.GasCardDef.CardCfg objCardCfg)
        {
        ...
        /// <returns></returns>
        public bool SetCfg(int iAddr, GlareLedSysDefPub.GasCardDef.CardCfg objCardCfg)
        {
        ...
        /// <returns></returns>
        public bool ReadOilVal(int iAddr, ref List<GlareLedSysDefPub.GasCardDef.CardOilValEachNumAByte> lstOilVal)
        {
