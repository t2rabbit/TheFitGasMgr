...
namespace GlareLedSysBll
{
    ...
    public class CardDevBll
    {
        ...
        public static List<GasCardInfo> GetDevByGwId(int iGwId)
        {
            using (GLedDbEntities ent = new GLedDbEntities())
            {
                List<GasCardInfo> devs = (from c in ent.GasCardInfo
        ...
        public static bool AddDev(ref GasCardInfo model, out string strError)
        {
            strError = "";
            try
            {
        ...
        public static bool UpdateDev(ref GasCardInfo model, out string strError)
        {
            strError = "";
            try
            {
