...
namespace DmitryBrant.CustomControls
{
    public class SevenSegment : UserControl
    {
        ...
        {
            this.SuspendLayout();
            this.Name = "SevenSegment" + (StNameIndex++);
                        ...
                        try
                        {
                            ...
                            switch (tempString.ToLower()[0])
                            {
                                ...
                                case ':': 
                                    ...
                                    break;
                                case '.':
                                    customPattern = (int)ValuePattern.BigDot;
                                    break;
                            }
                        }
                        catch { }
        ...
        private void InitializeComponent()
        {
            ...
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.SevenSegment_KeyPress);
            this.ResumeLayout(false);
        ...
        private void SevenSegment_KeyPress(object sender, KeyPressEventArgs e)
        {
