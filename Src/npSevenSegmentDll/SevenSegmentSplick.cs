...
{
    public partial class SevenSegmentSplick : UserControl
    {
        private void SevenSegmentSplick_Load(object sender, EventArgs e)
        {
        ...
        /// 点击是否会闪烁
        /// </summary>
        public bool BSplickAble { get; set; }

        private bool showDot = true;
        private bool dotUIOn = true;

        private void SevenSegmentSplick_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void SevenSegmentSplick_Enter(object sender, EventArgs e)
        {
            if (!BSplickAble)
            {
                if (t != null)
            ...
            if (t == null)
            {
                t = new System.Timers.Timer(500);//实例化Timer类，设置间隔时间为10000毫秒；
        ...
        private void SevenSegmentSplick_Leave(object sender, EventArgs e)
        {
            if (t != null)
            {
                t.Enabled = false;
        ...
        private void SevenSegmentSplick_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (BSplickAble)
            {
