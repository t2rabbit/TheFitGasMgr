...
Class AnUpLoad
	...
	Public Sub GetData()
		...
		'下面3句注释掉了，因为在IIS5.0中，如果上传大小大于限制大小的文件，会出错，一直没找到解决方法。如果是在IIS5以上的版本使用，可以Cancel下面3句的注释
		'If Not ef Then
	...
	'==============================
	' Get上传表单值,参数可选,如果为-1则返回一个包含所有表单项的一个dictionary对象
	'==============================
	...
	'==============================
	' Get上传的文件类,参数可选,如果为-1则返回一个包含所有上传文件类的一个dictionary对象
	'==============================
